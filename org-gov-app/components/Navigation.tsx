...
// Short labels, no icons. The previous set — a folder, a document, a clock —
// described nothing about the pages they sat on, and an icon that doesn't
// describe is noise. Type and position carry this instead.
const navItems = [
    { name: 'Overview', path: '/' },
    { name: 'Projects', path: '/projects' },
    { name: 'Catalyst Proposals', path: '/catalyst-proposals' },
    { name: 'BlockPrint Stats', path: '/org-stats' },
    { name: 'Contributors', path: '/contributors' },
];

// Brand marks, not decorative icons — these are how the accounts are
// identified, so they earn their place where a generic glyph would not.
            ...
            <div className={styles.inner}>
                <Link href="/" className={styles.mark}>
                    ...
                    <span className={styles.markText}>
                        <span className={styles.markName}>{config.mainOrganization.displayName}</span>
                        <span className={styles.markRole}>Governance record</span>
                    </span>
                </Link>
                    ...
                    {config.socialLinks.map((link) => (
                        ...
                        >
                            ...
                            <span className="visually-hidden">
                                {config.mainOrganization.displayName} on {link.name}
                            </span>
                        </a>
                    ))}
                </div>
